...
**PR Title:** `[PBM-PERF-1] add low detail mode to reduce graphics and memory usage`
- **Scope:** Add a low-detail mode for auction browse cards to reduce GPU load and animation overhead on graphics/memory-constrained devices.
